...
def custom_score_2(game, player):
    ...
    return float(len(game.get_blank_spaces()))
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def min_value(game, depth):
        ...
        games = [game.forecast_move(move) for move in legal_moves]
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for move in legal_moves:
            ...
            bestmove, bestscore = max([(bestmove,bestscore), (move, self.min_value(nextmove, depth-1))], key=lambda item: item[1])
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        # TODO: finish this function!
        #raise NotImplementedError
        best_score = self.max_value(game,depth,alpha,beta)
